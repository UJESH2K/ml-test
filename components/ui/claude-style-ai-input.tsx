...
export const ClaudeChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="bg-[#1e1e1e] border border-zinc-800 rounded-xl shadow-lg items-end gap-2 min-h-[100px] flex flex-col relative transition-all duration-300 hover:border-zinc-700">
        <textarea
          ref={textareaRef}
          value={message}
          ...
          disabled={disabled}
          className="flex-1 min-h-[80px] w-full p-4 focus-within:border-none focus:outline-none focus:border-none border-none outline-none focus-within:ring-0 focus-within:ring-offset-0 focus-within:outline-none max-h-[120px] resize-none border-0 bg-transparent text-zinc-100 shadow-none focus-visible:ring-0 placeholder:text-zinc-500 text-sm sm:text-base custom-scrollbar"
          rows={1}
        />
        <div className="flex items-center gap-2 justify-between w-full px-3 pb-2 pt-1 border-t border-zinc-800/50">
          <div className="flex items-center gap-2">
            <Button
              size="icon"
              variant="ghost"
              className="h-9 w-9 p-0 text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 flex-shrink-0 transition-colors"
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className={cn(
                ...
                canSend
                  ? "bg-indigo-600 hover:bg-indigo-500 text-white shadow-[0_0_10px_rgba(79,70,229,0.3)] hover:shadow-[0_0_15px_rgba(79,70,229,0.5)] transform scale-100 hover:scale-105"
        ...
        {(files.length > 0 || pastedContent.length > 0) && (
          <div className="overflow-x-auto border-t p-3 border-zinc-800 w-full bg-[#161616] hide-scroll-bar rounded-b-xl">
    ...
    <div className="w-full flex items-center justify-center p-4">
      <div className="w-full max-w-4xl">
        <ClaudeChatInput
          ...
          placeholder="Ask AI for insights on the current machine learning program..."
          maxFiles={10}
